    ...
    public partial class Cadastro : Form
    {
        ...
        private void butCadastro_Click(object sender, EventArgs e)
        {
            ...
            Cliente novoCliente = new()
            {
                ...
                etnia = (EtniaCliente)textEtnia.SelectedIndex,
                genero = (GeneroCliente)textGenero.SelectedIndex,
                tipo = radioPF.Checked ? TipoCliente.PF : TipoCliente.PJ,
                estrangeiro = checkEstrangeiro.Checked,
        ...
        private void Cadastro_Load(object sender, EventArgs e)
        {
            ...
            Enum.GetNames(typeof(EtniaCliente)).ToList().ForEach(etnia => textEtnia.Items.Add(etnia));

            BindingSource.DataSource = Cliente.ListarClientes();
            gridClientes.DataSource = BindingSource;
            //metodo feito dentro do form em si
        }
    }
}
